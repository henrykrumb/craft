    ...
    if   (is_free [id] || (age [id] % speed [id]) != 0)
        ...
        if   (cmd [id][0] == cmd_die)
            ...
            case object_explosion      :
                exec_explosion      (id);
                break;
            case object_building_zombi :
                exec_building_zombi (id);
                break;
            case object_swim           :
                exec_swim           (id);
                break;
...
void object_handler::exec_farm (int id) {
    ...
    /* handle_grown_shrink */      {
        ...
        if (power [id] < max_power_per_farm)
            ...
            /* search_new */      {
                int xx = i_random ( /* xmin */  i_max (x [id] - 5, 0),  /* xmax */  i_min (x [id] + 5, landscape_dx-1));
...
void object_handler::exec_market (int id) {
    ...
    /* handle_cmds */      {
        switch (cmd [id][0]) {
        case cmd_train_trader : { /* exec_train_trader */
...
void object_handler::exec_tents (int id) {
    ...
    /* handle_cmds */      {
        switch (cmd [id][0]) {
        case cmd_train_scout : { /* exec_train_scout */
            power [id] += (int) players [color_player [color [id]]]->grow_speed;
            if      (support [id] <= 0) { /* interrupt_training */
                power   [id] = 0;
                pop_order (id);
...
void object_handler::exec_camp (int id) {
    ...
    /* handle_cmds */      {
        switch (cmd [id][0]) {
        case cmd_train_knight : { /* exec_train_knight */
            power [id] += (int) players [color_player [color [id]]]->grow_speed;
            if      (support [id] <= 0) { /* interrupt_training */
                power   [id] = 0;
                pop_order (id);
        ...
        break;
        case cmd_idle         : { /* perhaps_new_unit */
...
void object_handler::exec_mill (int id) {
    ...
    /* handle_cmds */      {
        switch (cmd [id][0]) {
        case cmd_train_archer : { /* exec_train_archer */
            power [id] += (int) players [color_player [color [id]]]->grow_speed;
            if      (support [id] <= 0) { /* interrupt_training */
                power   [id] = 0;
                pop_order (id);
...
void object_handler::exec_uni (int id) {
    ...
    /* handle_cmds */      {
        switch (cmd [id][0]) {
        case cmd_train_doktor : { /* exec_train_doktor */
            power [id] += (int) players [color_player [color [id]]]->grow_speed;
            if      (support [id] <= 0) { /* interrupt_training */
                power   [id] = 0;
                pop_order (id);
...
void object_handler::exec_smith (int id) {
    ...
    /* handle_cmds */      {
        switch (cmd [id][0]) {
        case cmd_train_cata : { /* exec_train_cata */
            power [id] += (int) players [color_player [color [id]]]->grow_speed;
            if      (support [id] <= 0) { /* interrupt_training */
                power   [id] = 0;
                pop_order (id);
...
void object_handler::exec_docks (int id) {
    ...
    /* perform_actions */      {
        switch (cmd [id][0]) {
        case cmd_built_ship  :
        case cmd_built_bship : { /* exec_built_ship */
            /* perhaps_start_pic */      {
                if (power [id] == 0)
                    /* set_ship_pic */      {
            ...
            if (power [id] >= 100)
                ...
                if   (any_free_place) {
                    ...
                    push_order (id, cmd_wait, i_random (1, 200), 0);
                }
            };
            if (power [id] % 20 == 0) {
                version [id]++;
...
void object_handler::exec_home (int id) {
    ...
    /* perform_actions */      {
        switch (cmd [id][0]) {
        case cmd_train_worker : { /* exec_train_worker */
            int typ = object_worker;

            power [id] += (int) players [color_player [color [id]]]->grow_speed;
            if (power [id] >= 100)
                /* handle_train_finished */      { /* place_unit */      {
                    int  xx;
                    int  yy;
                    bool any_free_place;
        ...
        break;
        case cmd_train_pawn   : { /* exec_train_pawn */
            int typ = object_pawn;
...
int object_handler::create_worker (int p_x, int p_y, int p_color, int home) {
    ...
    id = create_object ();
    if (id != none)
        /* add_worker_data */      { /* add_object_data */      {
...
void object_handler::exec_worker (int id) {
    /* consume_food */      {
        double f =  /* player_food */      players [color_player [color [id]]]->food;
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 0)
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_worker / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
            /* ouhgh */      {
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* worker_handle_move_to */
            int goal_dist;
        ...
        break;
        case cmd_perform_steps : { /* worker_handle_steps */
            /* exec_step */      {
        ...
        case cmd_heap          :
            worker_harvest (id);
            break;
        case cmd_idle          : { /* worker_handle_idle */
        ...
        break;
        case cmd_stop          : { /* worker_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_hack          :
        ...
        case cmd_upgrade       :
            worker_upgrade (id);
            break;
        case cmd_wait          : { /* worker_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
        ...
        break;
        case cmd_setup_trap    : { /* worker_setup_trap */
            int xx = gx [id][0];
            int yy = gy [id][0];
        ...
        break;
        case cmd_dig_trap      : { /* worker_dig_trap */
            int xx = gx [id][0];
            int yy = gy [id][0];
...
void object_handler::worker_hack (int id) {
    if   (t [id] == 0)
        ...
        case harvest_gold  : { /* handle_minig_finished */
        ...
        break;
        case harvest_wood  : { /* handle_lumber_finished */
            bool anything_to_harvest;

            /* wood_to_harvest */      {
                anything_to_harvest =  /* pp */  land_properties [ /* ll */  landscape       [gx [id][0]][gy [id][0]]].is_forest;
            };
        ...
        break;
        case harvest_dig   : { /* handle_dig_finished */
        ...
        break;
        case harvest_heap  : { /* handle_heap_finished */
            bool over;
        ...
        break;
        case harvest_built : { /* handle_build_finished */
            pop_order (id);
        ...
        /* check_still_anything_to_harvest */      {
            ...
            switch (harvest_type [id]) {
            case harvest_gold  : { /* gold_to_harvest */
                anything_to_harvest = (m != none               &&
                                       type [m] == object_mine &&
                                       money [m] > 0);
            };
            break;
            case harvest_wood  : { /* wood_to_harvest */
                anything_to_harvest =  /* pp */  land_properties [ /* ll */  landscape       [gx [id][0]][gy [id][0]]].is_forest;
            };
            break;
            case harvest_dig   : { /* to_dig */
                anything_to_harvest =
                    land_properties [landscape [gx [id][0]][gy [id][0]]].is_dig &&
                    min_diff (gx [id][0], gy [id][0], 3);
            };
            break;
            case harvest_heap  : { /* to_heap */
...
void object_handler::worker_harvest (int id) {
    if   ( /* any_material */      (wood [id] != 0 || money [id] != 0))
        ...
        if   ( /* at_harvest_place */      ( /* near_by */      (i_abs (x [id] - gx [id][0]) <= 1 &&
            ...
            /* select_goal */      {
                switch (harvest_type [id]) {
                case harvest_gold  : { /* look_up_goal */
                    int xg;
                    int yg;
                ...
                break;
                case harvest_wood  : { /* look_up_goal */
                    int xg;
                    int yg;
                ...
                break;
                case harvest_dig   : { /* handle_dig_goal */
                    any_goal = ! interrupted [id];
                };
                break;
                case harvest_heap  : { /* handle_dig_goal */
                    any_goal = ! interrupted [id];
                };
                break;
                case harvest_built : { /* handle_build */
                    int m = unit [gx [id][0]][gy [id][0]];
...
int object_handler::create_trader (int p_x, int p_y, int p_color, int home) {
    ...
    id = create_object ();
    if (id != none)
        /* add_trader_data */      { /* add_object_data */      {
...
void object_handler::exec_trader (int id) {
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* trader_handle_move_to */
            if   ( /* no_way */     ! (( /* move_to_possible */      (land_properties [landscape [gx [id][0]][gy [id][0]]].walk_possible ||
                                       /* enter_ship */
        ...
        break;
        case cmd_perform_steps : { /* trader_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* trader_step_over */      {
                    pop_order (id);
        ...
        case cmd_trade         :
            ...
            break;
        case cmd_exec_trade    :
            trader_exec_trade (id);
            break;
        case cmd_idle          : { /* trader_handle_idle */
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_stop          : { /* trader_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_wait          : { /* trader_handle_wait */
...
void object_handler::trader_trade (int id) {
    if   ( /* anything_to_sell */      ((landscape [gx [id][0]][gy [id][0]] == land_t_wood && money [id] != 0) ||
        ...
        if   ( /* at_exit_place */      (x [id] == gx [id][0] && y [id] == gy [id][0]))
            /* exit */      {
            ...
            while ( /* any_cand */   (cand >= 0) && ! cand_at_goal) {
                /* prop */      { /* set_pot */      {
                        ...
                        if     (pot != INT_MAX) {
                            ...
                            f [ /* cx */         px [cand]][ /* cy */         py [cand]] = i_max (0, f [ /* cx */         px [cand]][ /* cy */         py [cand]]);
                        }
                    ...
                    /* check_at_goal */      {
                        double d = stepdist ( /* cx */         px [cand],  /* cy */         py [cand], gx [id][0], gy [id][0]);
                        int    u = unit [gx [id][0]][gy [id][0]];
                        bool   ship_at_goal;
                        ...
                        /* check_ship_at_goal */      {
                            ...
                            if   (sx >  /* cx */         px [cand]) {
                                ...
                                ship_at_goal &= (sx -  /* cx */         px [cand] == 0);
                            }
                            if   (sy >  /* cy */         py [cand]) {
                                ship_at_goal &= (sy -  /* cy */         py [cand] < 3);
                            } else {
                                ship_at_goal &= (sy -  /* cy */         py [cand] == 0);
                            }
                        };
...

{
    ...
    if ( /* within_field */      (0 <= xx && xx <= landscape_dx && 0 <= yy && yy <= landscape_dy))
        ...
        uu = unit      [xx][yy];
        /* check_step */      {
            if   ( /* step_possible */      (ff == -1 || ((ff == INT_MAX || ff == -2) &&
...
void object_handler::man_step (int id, int dx, int dy) {
    ...
    if (t [id] == step_t) { /* start_move */
        ...
        if   ( /* within_field */      (0 <= xx && xx < landscape_dx && 0 <= yy && yy < landscape_dy))
            ...
            if      ( /* goal_field_ship */      (g_unit              != none                                &&
                                                  ...
                                                  s [g_unit]->num_man < s [g_unit]->capa || g_unit==unit [x [id]][y [id]])) { /* perform_enter */
            ...
            } else if ( /* leave_ship */      (on_ship [id] != -1 &&  /* goal_field_free */      (g_unit == none &&  /* act_prop */       land_properties [ /* act_landscape */  landscape       [xx][yy]].walk_possible &&  /* no_hole */      (i_abs (landhight [x [id]][y [id]] - landhight [xx][yy]) < 2)))) {     /* perform_leave */
                ...
                s [on_ship [id]]->leave (id);
                on_ship [id]  =  -1;
            } else if ( /* goal_field_free */      (g_unit == none &&  /* act_prop */       land_properties [ /* act_landscape */  landscape       [xx][yy]].walk_possible &&  /* no_hole */      (i_abs (landhight [x [id]][y [id]] - landhight [xx][yy]) < 2))) { /* perform_start */
                int dh = landhight [x [id]+dx][y [id]+dy] - landhight [x [id]][y [id]];
                ...
                buf [id]      =  speed [id];
                if (dh > 0) {
                    speed [id] = (int) ((double) speed [id] * 3);
                }
                if (dh < 0) {
                    speed [id] = i_max (1, (int) ((double) speed [id] / 2));
                }
                if (on_ship [id] !=  -1) {
                    speed [id] = 1;
                }
    ...
    /* set_pic */      {
        switch (type [id]) {
        case object_worker : { /* set_worker_pic */
            if      (money [id] > 0)
        ...
        break;
        case object_trader : { /* set_trader_pic */
            if      (money [id] > 0)
                set_move_pic (id, pic_trader_gold (color [id]),
...
void object_handler::exec_water (int id) {
    if   (t [id] == speed_water)
        ...
        /* handle_over */      { /* check_neighbors */      {
            for (int xx =  /* xmin */  i_max (x [id] - 1, 0); xx <  /* xmax */  i_min (x [id] + 2, landscape_dx); xx++)
...
int object_handler::create_zombi (int id) {
    ...
    if   ( /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water)) {
        ...
        /* handle_support */      {
            switch (type [id]) {
            case object_knight : { /* handle_knight */
                int hm = home_id [id];
            ...
            break;
            case object_archer : { /* handle_archer */
                int hm = home_id [id];
            ...
            break;
            case object_doktor : { /* handle_doktor */
                int hm = home_id [id];
            ...
            break;
            case object_trader : { /* handle_trader */
                int hm = home_id [id];
            ...
            break;
            case object_scout  : { /* handle_scout */
                int hm = home_id [id];
...
void object_handler::exec_pawn (int id) {
    /* consume_food */      {
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 0)
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_pawn / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* pawn_handle_move_to */
            int dx;
            int dy;
            int max_d;
            int dxx;
        ...
        break;
        case cmd_perform_steps : { /* pawn_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* pawn_step_over */      {
                    pop_order (id);
        ...
        case cmd_hit           :
            ...
            break;
        case cmd_guard         :
        case cmd_idle          : { /* pawn_handle_idle */
        ...
        case cmd_upgrade       :
            pawn_upgrade     (id);
            break;
        case cmd_stop          : { /* pawn_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_wait          : { /* pawn_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...
int object_handler::create_scout (int p_x, int p_y, int p_color, int home_no) {
    ...
    id = create_object ();
    if (id != none)
        /* add_scout_data */      { /* add_object_data */      {
...
void object_handler::exec_scout (int id) {
    /* consume_food */      {
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 0)
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_scout / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* scout_handle_move_to */
            int dx;
            int dy;
            int max_d;
        ...
        break;
        case cmd_perform_steps : { /* scout_handle_steps */
            wood [id] = 0;
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* scout_step_over */      {
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_idle          : { /* scout_handle_idle */
        ...
        break;
        case cmd_stop          : { /* scout_handle_stop */
            pop_order (id);
            wood [id] = 0;
        };
        break;
        case cmd_wait          : { /* scout_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...
void object_handler::exec_ship (int id) {
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_sail          : { /* ship_handle_move_to */
            int dx;
            int dy;
            int max_d;
            int goal_d;
        ...
        case cmd_attack        :
            ship_attack (id);
            break;
        case cmd_perform_steps : { /* ship_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* ship_step_over */      {
                    pop_order (id);
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_idle          : { /* ship_handle_idle */
            if   (support [id] == 0)
                /* handle_battle_ship */      {
                if   (s [id]->empty ())
                    /* set_b_empty */      {
        ...
        break;
        case cmd_stop          : { /* ship_handle_stop */
            pop_order (id);
            wood [id] = 0;
        };
        break;
        case cmd_wait          : { /* ship_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...

{
    ...
    id = create_object ();
    if (id != none)
        /* add_knight_data */      { /* add_object_data */      {
...
void object_handler::exec_knight (int id) {
    /* consume_food */      {
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 70 && ! master [id])
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_knight / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* knight_handle_move_to */
            int dx;
            int dy;
            int max_d;
        ...
        break;
        case cmd_perform_steps : { /* knight_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* knight_step_over */      {
                    pop_order (id);
        ...
        case cmd_hit           :
            ...
            break;
        case cmd_guard         :
        case cmd_idle          : { /* knight_handle_idle */
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_stop          : { /* knight_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_wait          : { /* knight_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...
int object_handler::create_archer (int p_x, int p_y, int p_color, int home_no) {
    ...
    id = create_object ();
    if (id != none)
        /* add_archer_data */      { /* add_object_data */      {
...
void object_handler::exec_archer (int id) {
    /* consume_food */      {
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 70)
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_archer / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* archer_handle_move_to */
            int dx;
            int dy;
            int goal_dist;
            int max_d;
            ...
            if      ( /* at_goal */      (x [id] == gx [id][0] && y [id] == gy [id][0])) {
                ...
                if ( /* no_archer_way */     ! (( /* goal_free */      (unit [gx [id][0]][gy [id][0]] == none ||
                                                /* enter_ship */
                                                ( /* uu */ unit [gx [id][0]][gy [id][0]] != none && type [ /* uu */ unit [gx [id][0]][gy [id][0]]] == object_ship1)                            ||
        ...
        break;
        case cmd_perform_steps : { /* archer_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* archer_step_over */      {
                    pop_order (id);
        ...
        case cmd_hit           :
            ...
            break;
        case cmd_guard         :
        case cmd_idle          : { /* archer_handle_idle */
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_stop          : { /* archer_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_wait          : { /* archer_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...
void object_handler::exec_cata (int id) {
    /* consume_food */      {
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 0)
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_cata / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* cata_handle_move_to */
            if   (support [id] == 1)
                /* perform_move_to */      {
                int dx;
                int dy;
        ...
        break;
        case cmd_perform_steps : { /* cata_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* cata_step_over */      {
                    pop_order (id);
        ...
        case cmd_hit           :
            ...
            break;
        case cmd_guard         :
        case cmd_idle          : { /* cata_handle_idle */
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_stop          : { /* cata_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_load          :
            exec_cata_load (id);
            break;
        case cmd_wait          : { /* cata_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...
void object_handler::archer_sad (int id, bool follow) {
        ...
        /* push_attack */
    {
        ...
        push_order (id, cmd_wait, i_random (3, 10), 0);
    }
...
void object_handler::exec_archer_hit (int id) {
    if      (t [id] == duration_hit) { /* start_hit */
        ...
        if   (u != id && (u != none ||  /* cata_can_attack */      (type [id] == object_cata &&
            ...
            /* try_to_hit_unit */      {
            switch (type [id]) {
            case object_archer : { /* start_arrow */
                create_arrow (x [id], y [id], gx [id][0], gy [id][0], id);
            };
            break;
            case object_cata   : { /* start_stone */
        ...
        /* handle_load */      {
            switch (type [id]) {
            case object_archer :
                push_order (id, cmd_wait, i_random (1, 3), 0);
                break;
            case object_cata   :
                push_order (id, cmd_load, none, none);
                t [id] = duration_hit;
                break;
            };
        };
...

{
    ...
    id = create_object ();
    if (id != none)
        /* add_doktor_data */      { /* add_object_data */      {
...
void object_handler::exec_doktor (int id) {
    /* consume_food */      {
        ...
        if   ( /* player_food */      players [color_player [color [id]]]->food <= 0)
            ...
            /* player_food */      players [color_player [color [id]]]->food -= (double) speed_doktor / (double) speed_farm;
        };
    };
    /* check_health */      {
        if (health [id] <= 0 ||  /* on_water */      (on_ship [id]==-1 && land_properties [landscape[x[id]][y[id]]].is_water))
    ...
    /* exec_cmd */      {
        switch (cmd [id][0]) {
        case cmd_move_to       : { /* doktor_handle_move_to */
            int dx;
            int dy;
            int max_d;
            int uu1;
        ...
        break;
        case cmd_perform_steps : { /* doktor_handle_steps */
            /* exec_step */      {
                if   (step [id][0] == step_over)
                    /* doktor_step_over */      {
                    pop_order (id);
        ...
        case cmd_hit           :
            ...
            break;
        case cmd_guard         :
        case cmd_idle          : { /* doktor_handle_idle */
        ...
        case cmd_talk          :
            exec_talk (id);
            break;
        case cmd_stop          : { /* doktor_handle_stop */
            pop_order (id);
        };
        break;
        case cmd_wait          : { /* doktor_handle_wait */
            if   (gx [id][0] == 0) {
                pop_order (id);
            } else {
                gx [id][0]--;
...
void object_handler::doktor_attack (int id) {
    if   ( /* at_goal */      (((i_abs (x [id]-gx [id][0]) < 2) && (i_abs (y [id]-gy [id][0]) < 2)) ||
        ...
        if   ( /* out_of_range */      (gx [id][0] < attack_x_min [id] || gx [id][0] > attack_x_max [id] ||
                                        gy [id][0] < attack_y_min [id] || gy [id][0] > attack_y_max [id])) {
            pop_order (id);
            moving_goal [id] = none;
        } else { /* perform_move_to_steps */
...
int object_handler::create_arrow (int ax, int ay, int agx, int agy, int aid) {
    ...
    id = create_object ();
    if (id != none)
        /* add_arrow_data */      { /* add_object_data */      {
...
int object_handler::create_stone (int ax, int ay, int agx, int agy, int aid) {
    ...
    id = create_object ();
    if (id != none)
        /* add_stone_data */      { /* add_object_data */      {
...
void object_handler::exec_fighter_hit (int id) {
    if      (t [id] == duration_hit) { /* start_hit */
        ...
        if (u != none)
            /* try_to_hit_unit */      {
            if   ( /* landhight_ok */      (i_abs (i_max (0, landhight [x[id]][y[id]]) -
...

{
    ...
    if (building_can_be_placed)
        ...
        if   (type == object_docks) {
            ...
            id = create_building (x, y, object_building_site, 0, 0, color);
        }
        dir         [id] = type;
...

{
    ...
    id = create_object ();
    if (id != none)
        /* add_building_data */      { /* add_object_data */      {
        ...
        if (p_color != none)
            ...
            switch (p_type) {
            case object_camp  :
                players [color_player [p_color]]->num_camps++;
                ...
                break;
            case object_market:
                players [color_player [p_color]]->num_markets++;
                ...
                break;
            case object_tents :
                players [color_player [p_color]]->num_tents++;
                ...
                break;
            case object_farm  :
                players [color_player [p_color]]->num_farms++;
                break;
            case object_mill  :
                players [color_player [p_color]]->num_mills++;
                ...
                break;
            case object_smith :
                players [color_player [p_color]]->num_smiths++;
                ...
                break;
            case object_docks :
                players [color_player [p_color]]->num_docks++;
                break;
            case object_uni   :
                players [color_player [p_color]]->num_unis++;
                ...
                break;
            case object_home  :
                players [color_player[p_color]]->num_town_halls++;
                break;
            };
        };
...
void object_handler::refresh (int lx, int ly) {
    ...
    for (int i = 0; i < num_players; i++)
        /* show_one_player */      {
        if ( /* should_be_shown */       (players [i]->active))
            /* perform_show */      {
...
void object_handler::set_move_pic (int id, int base_pic, int d, int dx, int dy) {
    if   (type [id] == object_trader)
        ...
        case 0 :
            ...
            break;
        case 1 :
            pic [id] = base_pic + 35 + d;
            break;
        case 2 :
            pic [id] = base_pic + 30 + d;
            break;
        case 3 :
            pic [id] = base_pic + 15 + d;
            break;
        case 4 :
            pic [id] = base_pic + 10 + d;
            break;
        case 5 :
            pic [id] = base_pic + 25 + d;
            break;
        case 6 :
            pic [id] = base_pic + 20 + d;
            break;
        case 7 :
            pic [id] = base_pic +  5 + d;
            break;
...

{
    ...
    case cmd_built_uni    : { /* handle_building */
        bool building_can_be_placed;
    ...
    break;
    case cmd_built_docks  : { /* handle_docks */
        bool building_can_be_placed;
...
bool object_handler::attack_possible (int id, int x, int y) {
    ...
    if      (u != none) {
        return  /* attack_ok */      (color [u] != color [id] || is_building (type [u]));
    } else if (type [id] == object_cata) {
        return true;
    } else {
        return false;
...
void object_handler::new_order (int id, int order, int p1, int p2) {
    ...
    /* check_price_ok */      {
        ...
        case cmd_built_uni     :
            ...
            break;
        case cmd_attack        :
            price_ok = attack_possible (id, p1, p2);
            break;
        default                :
            price_ok = true;
            break;
    ...
    if (price_ok)
        ...
        /* push_new_order */      {
            ...
            /* store_aditional_params */      {
                switch (order) {
                case cmd_harvest      : { /* get_harvest_type */
                    if   ( /* lp */    land_properties [ /* ll */    landscape       [p1][p2]].is_forest) {
                ...
                break;
                case cmd_dig          : { /* get_dig_params */
                    harvest_type [id] = harvest_dig;
                };
                break;
                case cmd_heap         : { /* get_heap_params */
                    harvest_type [id] = harvest_heap;
                };
                break;
                case cmd_dig_row      : { /* get_dig_row_params */
                    int n_order = cmd_dig;
                ...
                break;
                case cmd_heap_row     : { /* get_heap_row_params */
                ...
                break;
                case cmd_train_worker : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_train_pawn   : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_train_scout  : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_train_archer : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_train_knight : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_train_cata   : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_train_doktor : { /* get_train_worker_params */
                    power [id] = 0;
                };
                break;
                case cmd_guard        : { /* add_guard_move */
                    push_order   (id, cmd_move_to, p1, p2);
                };
                break;
                case cmd_sad          : { /* get_sad_params */
                    moving_goal  [id] = none;
                    in_formation [id] = false;
                };
                break;
                case cmd_enter        : { /* get_attack_params */
                ...
                break;
                case cmd_attack       : { /* get_attack_params */
                    moving_goal  [id] = unit [p1][p2];
                    if (objects->type [id] == object_cata &&  /* zombi_attack */      (unit [p1][p2] != none &&
                            (objects->type [unit [p1][p2]] == object_zombi ||
                             objects->type [unit [p1][p2]] == object_schrott))) {
                ...
                break;
                case cmd_heal         : { /* get_attack_params */
                    moving_goal  [id] = unit [p1][p2];
                    if (objects->type [id] == object_cata &&  /* zombi_attack */      (unit [p1][p2] != none &&
                            (objects->type [unit [p1][p2]] == object_zombi ||
                             objects->type [unit [p1][p2]] == object_schrott))) {
                ...
                break;
                case cmd_built_camp   : { /* get_built_camp */
                ...
                break;
                case cmd_built_market : { /* get_built_market */
                ...
                break;
                case cmd_built_tents  : { /* get_built_tents */
                ...
                break;
                case cmd_built_farm   : { /* get_built_farm */
                ...
                break;
                case cmd_built_home   : { /* get_built_home */
                ...
                break;
                case cmd_built_mill   : { /* get_built_mill */
                ...
                break;
                case cmd_built_smith  : { /* get_built_smith */
                ...
                break;
                case cmd_built_docks  : { /* get_built_docks */
                ...
                break;
                case cmd_built_uni    : { /* get_built_uni */
                ...
                break;
                case cmd_move_to      : { /* perhaps_new_home */
...
void object_handler::readjust_land (int x, int y, int dh) {
    ...
    /* check_water */      {
        if (landhight [x][y] <= 0)
            /* perform_water_check */      {
            for (int xx =  /* xmin */  i_max (x - 1, 0); xx <  /* xmax */  i_min (x + 2, landscape_dx); xx++)
