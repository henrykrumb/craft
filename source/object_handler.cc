...
bool object_handler::any_object(int oid, int p_type, int p_color, int &id)
{
    for (id = 0; id < max_objects; id++)
        if (!is_free[id] && type[id] == p_type && color[id] == p_color &&
            /* home_proper */ ((p_type != object_home && p_type != object_market && p_type != object_tents) || can_walk_to(oid, 1, x[id], y[id])))
        {
            return true;
        }
    return false;
...
void object_handler::worker_hack(int id)
{
    ...
    { /* hack_a_bit */
        ...
        /* check_still_anything_to_harvest */ {
            ...
            case harvest_built:
            { /* to_built */
                anything_to_harvest = (m != none && (type[m] == object_building_site ||
    ...
    { /* try_to_get_material */
        if (/* at_harvest_place */ (/* near_by */ (i_abs(x[id] - gx[id][0]) <= 1 &&
                                                   ...
                                                   (cmd[id][0] != cmd_heap ||
                                                    landscape[gx[id][0]][gy[id][0]] == land_water ||
                                                    landhight[x[id]][y[id]] - landhight[gx[id][0]][gy[id][0]] < 2)) ||
                                    /* at_mine */ (harvest_type[id] == harvest_gold &&
                                                   /* uu */ unit[x[id] + i_sign(gx[id][0] - x[id])][y[id] + i_sign(gy[id][0] - y[id])] != none && type[/* uu */ unit[x[id] + i_sign(gx[id][0] - x[id])][y[id] + i_sign(gy[id][0] - y[id])]] == object_mine) ||
                                    /* at_building_site */ (harvest_type[id] == harvest_built &&
                                                            /* uu */ unit[x[id] + i_sign(gx[id][0] - x[id])][y[id] + i_sign(gy[id][0] - y[id])] != none && (type[/* uu */ unit[x[id] + i_sign(gx[id][0] - x[id])][y[id] + i_sign(gy[id][0] - y[id])]] == object_building_site || type[/* uu */ unit[x[id] + i_sign(gx[id][0] - x[id])][y[id] + i_sign(gy[id][0] - y[id])]] == object_site_docks))) &&
            !interrupted[id])
        /* harvest */ {
    ...
    /* exec_cmd */ {
        ...
        { /* trader_handle_move_to */
            if (/* no_way */ !((/* move_to_possible */ (land_properties[landscape[gx[id][0]][gy[id][0]]].walk_possible ||
                                ...
                                /* far_away */ ((i_abs(x[id] - gx[id][0]) > 1) || (i_abs(y[id] - gy[id][0]) > 1))) &&
                               man_plan_path(id, 0, false)))
            {
                pop_order(id);
                delay_wait(id);
            }
        ...
        { /* trader_handle_wait */
            ...
            if (gx[id][0] > 50 && /* near_trade_place */ ((cmd[id][1] == cmd_move_to && i_abs(gx[id][1] - x[id]) < 5 && i_abs(gy[id][1] - y[id]) < 5) || (cmd[id][2] == cmd_move_to && i_abs(gx[id][2] - x[id]) < 5 && i_abs(gy[id][2] - y[id]) < 5) || (cmd[id][3] == cmd_move_to && i_abs(gx[id][3] - x[id]) < 5 && i_abs(gy[id][3] - y[id]) < 5)) &&
                (cmd[id][1] == cmd_trade ||
                 cmd[id][2] == cmd_trade ||
                 cmd[id][3] == cmd_trade))
            /* handle_walk_away */ {
...
void object_handler::trader_exec_trade(int id)
{
    ...
    { /* set_pic */
        ...
        if (money[id] > 0)
            ...
            set_move_pic(id, pic_trader_move(color[id]),
                         0, dx, dy);
        refresh(x[id], y[id]);
    };
}
...

{
    ...
    if (/* at_goal */ /* start_dist_ok */ (d <= min_dist && /* start_heap_possible */ (cmd[id][1] != cmd_heap || landscape[gx[id][0]][gy[id][0]] == land_water || landhight[x[id]][y[id]] - landhight[gx[id][0]][gy[id][0]] < 2) && /* start_archer_shoot_ok */ (type[id] != object_archer || (min_dist < scope_archer - 1 || landhight[gx[id][0]][gy[id][0]] - landhight[x[id]][y[id]] < 3))) ||
            ...
            while (/* any_cand */ (cand >= 0) && !cand_at_goal)
            {
                /* prop */ { /* set_pot */
                                ...
                                for (int dy = -1; dy <= 1; dy++)
                                    ...
                                    /* get_neighbor_pot */ {
                                        ...
                                        if (0 <= xx && xx < landscape_dx && 0 <= yy && yy < landscape_dy &&
                                            f[xx][yy] >= 0 && fv[xx][yy] == pv && (/* no_hole */ (/* trav_on_water */ (land_properties[landscape[/* cx */ px[cand]][/* cy */ py[cand]]].is_water || land_properties[landscape[xx][yy]].is_water) || ((((/* cx */ px[cand] - xx) == 0 || (/* cy */ py[cand] - yy) == 0 || (/* uus */ unit[xx][yy] != none && type[/* uus */ unit[xx][yy]] == object_ship1)) && (i_abs(landhight[/* cx */ px[cand]][/* cy */ py[cand]] - landhight[xx][yy]) < 2)) || (i_abs(landhight[/* cx */ px[cand]][/* cy */ py[cand]] - landhight[xx][yy]) < 1))) || f[xx][yy] < 0))
                                        {
                    ...
                    /* check_at_goal */ {
                        ...
                        cand_at_goal = /* dist_ok */ (d <= min_dist && /* heap_possible */ (!cmd[id][1] == cmd_heap || landscape[gx[id][0]][gy[id][0]] == land_water || landhight[/* cx */ px[cand]][/* cy */ py[cand]] - landhight[gx[id][0]][gy[id][0]] < 2) && /* archer_shoot_ok */ (type[id] != object_archer || (min_dist < scope_archer - 1 || landhight[gx[id][0]][gy[id][0]] - landhight[/* cx */ px[cand]][/* cy */ py[cand]] < 3))) || /* at_unit */ (u != none && unit[/* cx */ px[cand]][/* cy */ py[cand]] == u && (color[u] != color[id] || type[u] != object_ship1)) || ship_at_goal;
                    };
                    if (!cand_at_goal)
                    /* push_neighbors */ {
                        int xx = /* cx */ px[cand];
                        ...
                        for (int dx = -1; dx <= 1; dx++)
                            for (int dy = -1; dy <= 1; dy++)
                                ...
                                /* check_step */ {
                                    ...
                                    if (0 <= xx && xx < landscape_dx && 0 <= yy && yy < landscape_dy)
                                        if (f[xx][yy] < p && fv[xx][yy] == pv && /* no_hol */ (/* travel_on_water */ (land_properties[landscape[xp][yp]].is_water || land_properties[landscape[xx][yy]].is_water) || ((((xp - xx) == 0 || (yp - yy) == 0 || (/* uu */ unit[xx][yy] != none && type[/* uu */ unit[xx][yy]] == object_ship1)) && (i_abs(landhight[xp][yp] - landhight[xx][yy]) < 2)) || (i_abs(landhight[xp][yp] - landhight[xx][yy]) < 1))) && f[xx][yy] >= 0)
                                        /* grab_new_p */ {
                                            another_step = true;
                                            sdx = dx;
                                            sdy = dy;
    ...
    /* handle_step */ {
        ...
        /* check_step */ {
            if (/* step_possible */ (ff == -1 || ((ff == INT_MAX || ff == -2) &&
                                                  /* no_trap */ !(ll == land_trap && is_a_trap[xx][yy] && players[color_player[color[id]]]->is_robot) &&
                                                  /* walk_is_possible */ ((!is_ship && land_properties[ll].walk_possible) || (is_ship && is_water(id, xx, yy, unit[gx[id][0]][gy[id][0]])) || (uu != none && uu == unit[gx[id][0]][gy[id][0]]) ||
                                                                          /* enter_or_leave_a_ship */ (uu != none && uu != id && !is_ship && type[uu] == object_ship1)) &&
                                                  /* no_unit */ (uu == none || uu == id || (uu != none && uu == unit[gx[id][0]][gy[id][0]]) ||
                                                                 /* enter_or_leave_a_ship */ (uu != none && uu != id && !is_ship && type[uu] == object_ship1) || (is_moving(uu) && color[uu] == color[id])) &&
                                                  (/* no_hole */ (/* travel_on_water */ (land_properties[ll].is_water &&
                                                                                         land_properties[landscape[x][y]].is_water) ||
                                                                  /* travel_from_or_to_ship */ (((uu != none && type[uu] == object_ship1) || (unit[x][y] != none && type[unit[x][y]] == object_ship1)) && i_abs(landhight[xx][yy] - landhight[x][y]) < 2) || /* anyway_possible */ (i_abs(landhight[xx][yy] - landhight[x][y]) < 1 || ((dx == 0 || dy == 0) && i_abs(landhight[xx][yy] - landhight[x][y]) < 2))) ||
                                                   ff == -2))))
            /* push_new_cand */ {
                cand++;
                px[cand] = xx;
    ...
    { /* start_move */
        ...
        /* handle_start */ {
            ...
            if (/* goal_field_ship */ (g_unit != none &&
                                           ...
                                           s[g_unit]->num_man < s[g_unit]->capa ||
                                       g_unit == unit[x[id]][y[id]]))
            { /* perform_enter */
            ...
            else if (/* leave_ship */ (on_ship[id] != -1 && /* goal_field_free */ (g_unit == none && /* act_prop */ land_properties[/* act_landscape */ landscape[xx][yy]].walk_possible && /* no_hole */ (i_abs(landhight[x[id]][y[id]] - landhight[xx][yy]) < 2))))
            { /* perform_leave */
            ...
            else if (/* goal_field_free */ (g_unit == none && /* act_prop */ land_properties[/* act_landscape */ landscape[xx][yy]].walk_possible && /* no_hole */ (i_abs(landhight[x[id]][y[id]] - landhight[xx][yy]) < 2)))
            { /* perform_start */
                int dh = landhight[x[id] + dx][y[id] + dy] - landhight[x[id]][y[id]];
            ...
            { /* homing_or_over */
                ...
                /* over */ {
                    ...
                    if ((/* is_sad */ (g_unit != none &&
                         ...
                         !/* out_of_range */ (gx[id][0] < attack_x_min[id] || gx[id][0] > attack_x_max[id] ||
    ...
    /* set_pic */ {
        ...
        { /* set_worker_pic */
            if (money[id] > 0)
                ...
                set_move_pic(id, pic_worker_move(color[id]),
                             step_t - t[id], dx, dy);
        };
        break;
        case object_trader:
                ...
                for (int sx = xx; sx < xx + 3 && goal_field_free; sx++)
                    for (int sy = yy; sy < yy + 3 && goal_field_free; sy++)
                        if (sx < landscape_dx && sy < landscape_dy &&
                                !/* on_water */ land_properties[landscape[sx][sy]].is_water ||
                            (unit[sx][sy] != none &&
                             unit[sx][sy] != id))
                        {
            ...
            /* grab_new_enemy */
            {
                ...
                /* perhaps_attack */ {
                    ...
                    if (u != none && u != id && color[u] != color[id] &&
                        /* near_by */ (/* near_ship */ (on_ship[id] != -1 && ship_on_side(x[id], y[id], u, ex[id], ey[id]) && type[u] == object_ship1 && !s[u]->empty()) || /* is_neighbor */ (i_abs(x[id] - ex[id]) <= idle_attack_r[id] && i_abs(y[id] - ey[id]) <= idle_attack_r[id]) || /* guard_event */ (cmd[id][0] == cmd_guard && i_abs(x[id] - ex[id]) <= guard_range && i_abs(y[id] - ey[id]) <= guard_range)) && !/* hidden */ (type[u] == object_scout && wood[u] == 1))
                    /* attack_archer */ {
                    ...
                    /* try_look */ {
                        ...
                        /* grab_enemy */ {
                            ...
                            if (/* near_by */ (/* near_ship */ (on_ship[id] != -1 &&
                                                                ...
                                                                type[u] == object_ship1 &&
                                                                !s[u]->empty()) ||
                                               /* is_neighbor */ (i_abs(x[id] - ex[id]) <= idle_attack_r[id] && i_abs(y[id] - ey[id]) <= idle_attack_r[id]) || /* guard_event */ (cmd[id][0] == cmd_guard && i_abs(x[id] - ex[id]) <= guard_range && i_abs(y[id] - ey[id]) <= guard_range)))
                            /* perhaps_attack */ {
                                int u = unit[ex[id]][ey[id]];
    ...
    /* exec_cmd */ {
        ...
        { /* scout_handle_move_to */
            ...
            if (!/* goal_free */ (unit[gx[id][0]][gy[id][0]] == none ||
                                  ...
                                  (/* uu */ unit[gx[id][0]][gy[id][0]] != none && type[/* uu */ unit[gx[id][0]][gy[id][0]]] == object_ship1) ||
                                  is_g_moving(unit[gx[id][0]][gy[id][0]])) &&
                !/* far_battle_point */ (/* uu */ unit[gx[id][0]][gy[id][0]] == none || /* uu */ unit[gx[id][0]][gy[id][0]] != unit[x[id] + dx][y[id] + dy] ||
                                         type[/* uu */ unit[gx[id][0]][gy[id][0]]] == object_ship1 && (color[/* uu */ unit[gx[id][0]][gy[id][0]]] == color[id] || s[/* uu */ unit[gx[id][0]][gy[id][0]]]->empty())))
            {
                gx[id][0] = x[id] + dx;
                gy[id][0] = y[id] + dy;
        ...
        { /* ship_handle_move_to */
                                     ...
                                     ship_on_side(x[id], y[id], moving_goal[id], gx[id][0], gy[id][0]))))
            {
                pop_order(id);
                                              ...
                                              goal_d > 0) ||
                     /* no_ship_way */ !((/* goal_free */ (unit[gx[id][0]][gy[id][0]] == none ||
                                                           unit[gx[id][0]][gy[id][0]] == id ||
                                                           (int)dist(x[id], y[id], gx[id][0], gy[id][0]) > 2 ||
                                                           is_g_moving(unit[gx[id][0]][gy[id][0]])) ||
                                          /* far_away */ ((i_abs(x[id] - gx[id][0]) > 1) || (i_abs(y[id] - gy[id][0]) > 1))) &&
                                         man_plan_path(id, goal_d, max_d, false)))
            {
                pop_order(id);
                delay_wait(id);
            };
        ...
        { /* knight_handle_move_to */
                     ...
                     !players[color_player[color[id]]]->is_robot)
            {
                ...
                delay_wait(id);
                                                             ...
                                                             (uu != none && type[uu] == object_ship1) || is_g_moving(uu)) ||
                                            /* far_away */ ((i_abs(x[id] - gx[id][0]) > 1) ||
                                                            (i_abs(y[id] - gy[id][0]) > 1) ||
                                                            !/* landhight_ok */ (i_abs(landhight[x[id]][y[id]] - landhight[gx[id][0]][gy[id][0]]) < 2))) &&
                                           man_plan_path(id, 0, max_d, false)))
        ...
        { /* knight_handle_idle */
            ...
            /* grab_new_enemy */
            {
                ...
                /* perhaps_attack */ {
                    ...
                    if (u != none && u != id && color[u] != color[id] && /* near_by */ (/* near_ship */ (on_ship[id] != -1 && ship_on_side(x[id], y[id], u, ex[id], ey[id]) && type[u] == object_ship1 && !s[u]->empty()) || /* is_neighbor */ (i_abs(x[id] - ex[id]) <= idle_attack_r[id] && i_abs(y[id] - ey[id]) <= idle_attack_r[id]) || /* guard_event */ (cmd[id][0] == cmd_guard && i_abs(x[id] - ex[id]) <= guard_range && i_abs(y[id] - ey[id]) <= guard_range)) && !/* hidden */ (type[u] == object_scout && wood[u] == 1))
                    /* attack_archer */ {
                        push_order(id, cmd_attack, ex[id], ey[id]);
                        attack_x_min[id] = ex[id] - idle_attack_r[id] - 1;
                        attack_y_min[id] = ey[id] - idle_attack_r[id] - 1;
        ...
        { /* archer_handle_move_to */
            ...
            else
            {
                if (/* no_archer_way */ !((/* goal_free */ (unit[gx[id][0]][gy[id][0]] == none ||
                                                            ...
                                                            (/* uu */ unit[gx[id][0]][gy[id][0]] != none && type[/* uu */ unit[gx[id][0]][gy[id][0]]] == object_ship1) ||
                                                            is_g_moving(unit[gx[id][0]][gy[id][0]])) ||
                                           /* far_away */ ((int)dist(x[id], y[id], gx[id][0], gy[id][0]) > scope_archer)) &&
                                          man_plan_path(id, goal_dist, max_d, false)))
                /* handle_no_way */ {
                    if (landscape[x_no_way][y_no_way] == land_water ||
                        landscape[x_no_way][y_no_way] == land_sea ||
                        /* robot_waits_to_long */ (players[color_player[color[id]]]->is_robot && delay[id] > 5) ||
        ...
        { /* archer_handle_idle */
            ...
            /* grab_new_enemy */
            {
                ...
                /* perhaps_attack */ {
                    ...
                    if (u != none &&
                        u != id &&
                        /* near_by */ (dist(x[id], y[id], ex[id], ey[id]) <= scope_archer + 1 && (type[u] != object_ship1 || !s[u]->empty())) &&
                        color[u] != color[id] &&
            ...
            /* perform_move_to */ {
                         ...
                         !players[color_player[color[id]]]->is_robot)
                {
                    ...
                    delay_wait(id);
                                                               ...
                                                               (/* uu */ unit[gx[id][0]][gy[id][0]] != none && type[/* uu */ unit[gx[id][0]][gy[id][0]]] == object_ship1) ||
                                                               is_g_moving(unit[gx[id][0]][gy[id][0]])) ||
                                              /* far_away */ ((int)dist(x[id], y[id], gx[id][0], gy[id][0]) > scope_cata)) &&
                                             man_plan_path(id, goal_dist, max_d, false)))
                /* handle_no_way */ {
                    if (landscape[x_no_way][y_no_way] == land_water ||
                        landscape[x_no_way][y_no_way] == land_sea ||
        ...
        { /* cata_handle_idle */
            ...
            /* grab_new_enemy */
            {
                ...
                /* perhaps_attack */ {
                    ...
                    if (u != none &&
                        u != id &&
                        /* near_by */ (dist(x[id], y[id], ex[id], ey[id]) <= scope_cata + 1 && u != none && (type[u] != object_ship1 || !s[u]->empty())) &&
                        color[id] != color[u] &&
                        !/* hidden */ (type[u] == object_scout && wood[u] == 1))
                    /* attack_archer */ {
                        push_order(id, cmd_attack, ex[id], ey[id]);
    ...
    /* try_to_attack */ {
        ...
        { /* suspend_attack */
            ...
            if (mg != none &&
                ...
                (/* at_m_goal */ dist(x[id], y[id], x[moving_goal[id]], y[moving_goal[id]]) <= weapon_dist || type[id] == object_archer))
            /* readjust_goal */ {
                gx[id][0] = x[moving_goal[id]];
                gy[id][0] = y[moving_goal[id]];
...
void object_handler::exec_archer_hit(int id)
{
    ...
    { /* finish_hit */
        ...
        if (u != id && (u != none || /* cata_can_attack */ (type[id] == object_cata && moving_goal[id] == none && landscape[gx[id][0]][gy[id][0]] == land_wall)) && /* dist_ok */ (int)dist(x[id], y[id], gx[id][0], gy[id][0]) <= weapon_dist)
        /* try_to_hit_unit */ {
            switch (type[id])
            {
            case object_archer:
                ...
                /* try_look */ {
                    ...
                    /* grab_enemy */ {
                        ...
                        if (/* near_by */ (/* is_neighbor */ (i_abs(x[id] - ex[id]) <= idle_attack_r[id] &&
                                           ...
                                           /* guard_event */ (cmd[id][0] == cmd_guard && i_abs(x[id] - ex[id]) <= guard_range && i_abs(y[id] - ey[id]) <= guard_range) ||
...
void object_handler::exec_doktor_hit(int id)
{
    ...
    { /* finish_hit */
        ...
        if (/* land_target */ (u != none &&
                               u == moving_goal[id] &&
                               moving_id[id] == oid[u] &&
                               /* hight_ok */ (i_abs(landhight[x[id]][y[id]] - landhight[gx[id][0]][gy[id][0]]) < 2)))
        /* try_to_hit_unit */ {
            if (color[u] == color[id])
            /* try_heal */ {
...
bool object_handler::direct_move(int id, int range, int &dx, int &dy)
{
    ...
    while (!/* at_goal */ ((i_abs(xx - gx[id][0]) <= range) &&
                           ...
                           /* can_attack */ (/* knight_can_attack */ ((type[id] == object_pawn || type[id] == object_knight || type[id] == object_doktor) && (i_abs(landhight[xx][yy] - landhight[gx[id][0]][gy[id][0]]) < 2)) || /* archer_can_attack */ (type[id] == object_archer && (landhight[gx[id][0]][gy[id][0]] - landhight[xx][yy]) < 3) ||
                                             /* cata_can_attack */ (type[id] == object_cata) || /* trader_can_move */ (type[id] == object_trader && i_abs(landhight[xx][yy] - landhight[gx[id][0]][gy[id][0]]) < 2 && (unit[xx][yy] == none || unit[xx][yy] == id)))))
    {
        /* try_step */ {
            int xn = xx + i_sign(gx[id][0] - xx);
            int yn = yy + i_sign(gy[id][0] - yy);

            if (/* walk_ok */ land_properties[landscape[xn][yn]].walk_possible && /* no_hole */ (i_abs(landhight[xx][yy] - landhight[xn][yn]) < 2) && /* no_trap */ !(landscape[xx][yy] == land_trap && is_a_trap[xx][yy] && players[color_player[color[id]]]->is_robot) && unit[xn][yn] == none)
            /* do_step */ {
                xx = xn;
                yy = yn;
            }
    ...
    { /* action */
        /* check_at_goal */ {
            ...
            at_goal = /* land_goal_ok */ (gu == moving_goal[id] &&
                                          ...
                                          /* landhight_ok */ (i_abs(landhight[x[id]][y[id]] - landhight[gx[id][0]][gy[id][0]]) < 2 || landscape[gx[id][0]][gy[id][0]] == land_water || landscape[gx[id][0]][gy[id][0]] == land_sea)) ||
                      /* ship_goal_ok */ (on_ship[id] != -1 &&
            ...
            for (int xx = 0; xx < bdx; xx++)
                ...
                /* set_field */ {
                    ...
                    if (p_type == object_docks)
                        ...
                        landpic[x[id] + xx][y[id] + yy] = building_pic(p_type,
                                                                       xx,
                                                                       yy,
                                                                       health[id]);
                    if (p_color != none)
                ...
                /* collect_catas */ {
                    for (int i = 0; i < max_objects && support[id] > 0; i++)
                        if (/* is_homeless_cata */ (!is_free[i] &&
                                                    ...
                                                    type[i] == object_cata &&
                                                    ((home_id[i] == none && home_id[i] < max_objects) ||
                                                     is_free[home_id[i]] || (type[home_id[i]] != object_smith && type[home_id[i]] != object_ship1))))
                        /* grab_cata */ {
                            support[id]--;
                            home_id[i] = id;
                        };
