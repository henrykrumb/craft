        ...
        /* get_f */ { /* get_ff */
            {
                ...
                /* start_an_attack */ {
                    num_hasar = i_random(1, i_min(5, /* fighters */ (num_knights + num_archers + num_catas + num_pawns) / 2));
                };
            };
            if (!f_init)
            /* get_ilf */ {
                ...
                /* exec_normal */ {
                    ...
                    /* exec_object */ {
                        ...
                        /* gen_new_order */ {
                            ...
                            { /* cmd_worker */
                                ...
                                /* gen_a_new_worker_cmd */ {
                                    if (/* ee */ /* no_cmd */ (objects->cmd[o][0] == cmd_idle) && /* ship_needs_a_worker */ (need_a_captain != -1 &&
                                                                                                                             crew_worker > 0 &&
                                                                                                                             /* act_if */ ilf->f[objects->x[o]][objects->y[o]] == captain_isle &&
                                                                                                                             ilf->num_worker[/* act_if */ ilf->f[objects->x[o]][objects->y[o]]] > ilf->num_homes[/* act_if */ ilf->f[objects->x[o]][objects->y[o]]] * 2))
                                    {
                                        b = 1;
                                        worker_to_ship(o);
                                    };
                                    if (/* ee */ /* no_cmd */ (objects->cmd[o][0] == cmd_idle) && /* need_heapie */ (num_heapies_required > 0))
                                    {
                                        b = 2; /* gen_heapie */
                                        {
                                            ...
                                            /* handle_heap_request */ {
                                                switch (landscape[/* heap_req_x */ heap_x[num_heapies_required]][/* heap_req_y */ heap_y[num_heapies_required]])
                                                {
                                                case land_water:
                                                { /* cross_river */
                                                    int x;
                                                    ...
                                                    /* look_for_river */ {
                                                        int dxb = /* heap_req_x */ heap_x[num_heapies_required] - objects->x[o];
                                                ...
                                                { /* heap_at_wall */
                                                    ...
                                                    /* check_no_archer */ {
                                                        ...
                                                        /* check_obj */ {
                                                            int xmi = i_max(0, /* heap_req_x */ heap_x[num_heapies_required] - scope_cata);
                                                    ...
                                                    if (no_archer)
                                                    /* do_heap_at_wall */ {
                                                        objects->push_order(o, cmd_dig, /* heap_req_x */ heap_x[num_heapies_required], /* heap_req_y */ heap_y[num_heapies_required]);
                                    ...
                                    if (/* ee */ /* no_cmd */ (objects->cmd[o][0] == cmd_idle) && /* town_hall_needed */ (players[pno]->num_town_halls + players[pno]->town_hall_in_progress < 2))
                                    {
                                        b = 3; /* gen_town_hall */
                                        {
                                            int x;
                                                ...
                                                /* get_t_place */ {
                                                    ...
                                                    for (int i = 0; /* still_a_bit_time */ (                                  /* used_time */
                                                                                            (x_sys_time() - s_time) < 100 || (/* used_time */
                                                                                                                              (x_sys_time() - s_time) < 300 && i < 10));
                                                         i++)
                                                    /* try_t_field */ {
                                                        x = i_random(/* xmin */ i_max(0, cx - 15), /* xmax */ i_min(landscape_dx, cx + 15));
                                            ...
                                            /* gen_harvester */ {
                                                if (/* too_far_from_home */ (objects->home_id[o] >= max_objects ||
                                                ...
                                                /* get_new_home */ {
                                                    ...
                                                    /* choose_best */ {
                                                        if (i_random(0, 100) > 50 && /* can_walk_to_0 */ can_walk_to(11, o, h_x[0], h_y[0], 1))
                                                        {
                                                    ...
                                                    /* do_harvest_wood */
                                                    {
                                                        ...
                                                        { /* walk_somewhere */
                                                            ...
                                                            if (can_walk_to(8, o, x, y, 0))
                                                            {
                                                                ...
                                                                {
                                                                    objects->new_order(o, cmd_dig_trap, x, y);
                                                                }
                                                            };
                                                        };
                                                    }
                                    ...
                                    if (/* ee */ /* no_cmd */ (objects->cmd[o][0] == cmd_idle) && /* need_trap */ (num_trapies_required > 0 && num_trap_run < 1))
                                    {
                                        b = 11; /* gen_trap */
                                        {
                                            num_trapies_required--;
                                            if (can_walk_to(6, o, /* trap_req_x */ trap_x[num_trapies_required], /* trap_req_y */ trap_y[num_trapies_required], 1, false))
                                            /* handle_trap_request */ { /* trap_at_wall */
                                                {
                                                    bool no_archer;
                                                    ...
                                                    if (no_archer)
                                                    /* do_trap_at_wall */ {
                                                        objects->push_order(o, cmd_dig_trap, /* trap_req_x */ trap_x[num_trapies_required], /* trap_req_y */ trap_y[num_trapies_required]);
                                                    };
                                                };
                                    ...
                                    if (/* ee */ /* no_cmd */ (objects->cmd[o][0] == cmd_idle) && need_a_captain > 0)
                                    {
                                        b = 13;
                                        move_to_ship(o);
                                    };
                                    if (/* ee */ /* no_cmd */ (objects->cmd[o][0] == cmd_idle) && /* should_harvest */ (players[pno]->num_town_halls > 0))
                                    {
                                        b = 14; /* gen_harvester */
                                        {
                                            if (/* too_far_from_home */ (objects->home_id[o] >= max_objects ||
                                            ...
                                            /* look_for_nice */ {
                                                ...
                                                for (int i = 0; i < ilf->num_il; i++)
                                                    if (ilf->num_worker[i] == 0 &&
                                                        ...
                                                        /* anything_to_get */ (ilf->num_mines[i] > 0 || (ilf->num_trade[i] > 0 && players[pno]->num_markets < 1)) &&
                                                        i_random(1, 100) > 5 &&
                        ...
                        { /* check_health_or_tp */
                            ...
                            if (objects->health[o] < 100 && /* is_fighter */ (objects->type[o] == object_pawn || objects->type[o] == object_knight || objects->type[o] == object_archer || objects->type[o] == object_cata || objects->type[o] == object_doktor) && /* not_moving */ objects->cmd[o][0] != cmd_move_to &&
...
{
    return (((players[pno]->num_camps > 0 &&
...
void robot::move_a_bit()
{
    ...
    /* handle_other */ {
        ...
        /* get_pot */ {
            ...
            /* get_approach */ {
                d = (double)/* fighters */ (num_knights + num_archers + num_catas + num_pawns) / (double)players[0]->num_mans;
                if (d < 0.8)
                {
                    pot += (int)(/* pot_diff */ (double)(f->max_p - f->f[x][y]) * 0.2 * robo_agress);
                }
                else if (d < 1.2)
                {
                    pot += (int)(/* pot_diff */ (double)(f->max_p - f->f[x][y]) * 0.3 * robo_agress);
                }
                else if (d < 1.5)
                {
                    pot += (int)(/* pot_diff */ (double)(f->max_p - f->f[x][y]) * 0.5 * robo_agress);
                }
                else
                {
                    pot += (int)(/* pot_diff */ (double)(f->max_p - f->f[x][y]));
                }
            };
        };
        ...
        /* change_place */ {
            ...
            /* move_to_new_goal */ {
                ...
                {
                    doing[o] = doing_attack;
                }
            }
            else
            { /* handle_goal_unreachable */
                if (/* man_under_fire */ (objects->type[o] != object_worker &&
                                          pf->f[objects->x[o]][objects->y[o]] > 0))
                /* try_to_escape */ {
                    int x = objects->x[o];
                    int y = objects->y[o];
...
void robot::handle_trader()
{
    ...
    {
        objects->new_order(o, cmd_trade, xtp[gold_tp], ytp[gold_tp]);
    }
}
...

{
    ...
    /* start_heap */ {
        ...
        if (/* any_obstacle */ (landscape[objects->x_no_way][objects->y_no_way] == land_water ||
            ...
            !sea_around && !allready_in_work)
        /* start_new_order */ { /* heap_req_x */
            heap_x[num_heapies_required] = objects->x_no_way;
        ...
        /* check_mine */ {
            ...
            if ((m != none &&
                 (objects->is_free[m] ||
                  ...
                  objects->color[m] != objects->color[o])) ||
                m == none)
            {
                h_mine[i] = -1;
                h_cnt[i] = 0;
...
bool robot::robo_can_built(int o, int xx, int yy)
{
    ...
    /* check_size */ {
        for (int x = /* xmin */ i_max(0, xx - 1); x < /* xmax */ i_min(landscape_dx, xx + 3); x++)
...
bool robot::look_for_dock_place(int &x, int &y, double dx, double dy)
{
    ...
    /* search_water */ {
        while (landscape[(int)xx][(int)yy] != land_water && /* inside */ (0 < (int)xx &&
    ...
    /* look_for_a_dock_place */ {
        for (int xa = (int)xx - (3 * /* idx */ (int)d_sign(dx)); xa != (int)xx; xa += /* idx */ (int)d_sign(dx))
...
bool robot::isle_goal(int o, int isle, int &xg, int &yg)
{
    ...
    /* search_cost */ {
        while (/* inside */ (0 <= /* xp */ (int)xx && /* xp */ (int)xx < landscape_dx && 0 <= /* yp */ (int)yy && /* yp */ (int)yy < landscape_dy) && (!/* on_water */ (landscape[/* xp */ (int)xx][/* yp */ (int)yy] == land_water || landscape[/* xp */ (int)xx][/* yp */ (int)yy] == land_sea) || !/* is_reachable */ (reachable = can_walk_to(22, o, /* xp */ (int)xx, /* yp */ (int)yy, 0))))
        {
            /* incr */ {
                int xa = /* xp */ (int)xx;
                int ya = /* yp */ (int)yy;
