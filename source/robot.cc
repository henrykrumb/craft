...
void robot::move_a_bit () {
    ...
    /* perhaps_to_ship */      {
        if (need_a_captain > 0 && objects->on_ship [o] == -1)
            ...
            case object_archer :
            case object_cata   :
                if (crew_fighter > 0) { /* fighter_to_ship */
                    if (can_walk_to (18,
                                     o,
                                     objects->x [need_a_captain],
                                     objects->y [need_a_captain], 0)) {
                ...
                break;
            case object_doktor :
                if (crew_healer  > 0) { /* healer_to_ship */
                    if (can_walk_to (17,
                                     o,
                                     objects->x [need_a_captain],
                                     objects->y [need_a_captain], 0)) {
