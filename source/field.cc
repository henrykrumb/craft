            ...
            for (int x = 0; x < landscape_dx; x++)
                ...
                /* dump_f */ {
                    ...
                    if (f[x][y] == blocked)
                    {
                        ...
                        w->set_color((int)(62.0 * (double)(f[x][y] - min) /
                                           (double)(max - min)));
...
void field::nbest(int &x, int &y)
{
    ...
    for (int j = 0; j < 10; j++)
    /* check_new */ {
        nbest(/* xmin */ i_max(0, x - j), /* ymin */ i_max(0, y - j), /* xmax */ i_min(landscape_dx - 1, x + j), /* ymin */ i_max(0, y - j), p0, pbest, xx, yy);
        /* check_over */ {
            if (pbest == 0)
            {
                x = xx;
...
void field::nbest(int &x, int &y, field *pf)
{
    ...
    for (int j = 0; j < 10; j++)
    /* check_new */ {
        nbest(/* xmin */ i_max(0, x - j), /* ymin */ i_max(0, y - j), /* xmax */ i_min(landscape_dx - 1, x + j), /* ymin */ i_max(0, y - j), p0, pbest, xx, yy, pf);
        /* check_over */ {
            if (pbest == 0)
            {
                x = xx;
