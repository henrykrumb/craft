    ...
    /* open_windows */ { /* init_sun_cnt */
        ...
        /* open_w_pause */ {
            ...
            w_pause = new win(w_craft, f_name, host,
                              0, w_craft_dy - w_inform_dy - w_unit_dy - (num_players * 25 + 28),
...

{
    ...
    /* perform_get */ {
        ...
        /* handle_marking */ {
            ...
            /* handle_mark_event */ {
                if (/* is_new_marking */ (b == button1press))
                { /* try_to_mark_new */
                    int mx;
                    int my;
                ...
                else if (/* is_add_marking */ (b == button2press))
                { /* try_to_add_mark */
                    int mx;
                    int my;
                ...
                else if (/* is_center */ (b == button3press))
                { /* center_screen */
                    int nx;
                    int ny;
                    int mx;
                        ...
                        /* check_pos_ok */ {
                            ...
                            { /* look_for_enemy */
                                ...
                                pos_ok = objects->type[marked[act][0]] == object_cata ||
                                         /* ship_goal_ok */ (objects->type[marked[act][0]] == object_ship1 && objects->s[marked[act][0]]->num_cata() > 0 && landscape[mx][my] == land_wall) ||
                                         (u != none &&
                                          objects->type[u] != object_zombi &&
