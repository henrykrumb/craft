...

{
    ...
    /* pharse_params */ {
        ...
        {
            /* grab_button */ {
                max_b_title_dx = i_max(max_b_title_dx, /* title_length */ XTextWidth(font_info, /* act_title */ b_title[num_buttons], strlen(/* act_title */ b_title[num_buttons])));
                num_buttons++;
            };
        };
        /* close_font_info */ {
