...
int docks_pic (int dir, int dx, int dy, int state) {
    switch (dir) {
    case 0:
        return pic_docks + dy * 3 + dx;
        break;
    case 2:
        return pic_docks + dy * 3 + dx + 30;
        break;
    case 4:
        return pic_docks + dy * 3 + dx + 10;
        break;
    case 6:
        return pic_docks + dy * 3 + dx + 20;
        break;
    };
}
...
int docks_ship_pic (int dir, int dx, int dy, int state) {
    switch (dir) {
    case 0:
        return xpic_ship_on_dock + dy * 3 + dx;
        break;
    case 2:
        return xpic_ship_on_dock + dy * 3 + dx + 30;
        break;
    case 4:
        return xpic_ship_on_dock + dy * 3 + dx + 10;
        break;
    case 6:
        return xpic_ship_on_dock + dy * 3 + dx + 20;
        break;
    };
}
...
int docks_site_pic (int dir, int dx, int dy, int state) {
    switch (dir) {
    case 0:
        return pic_docks_built + dy * 3 + dx;
        break;
    case 2:
        return pic_docks_built + dy * 3 + dx + 30;
        break;
    case 4:
        return pic_docks_built + dy * 3 + dx + 10;
        break;
    case 6:
        return pic_docks_built + dy * 3 + dx + 20;
        break;
    };
}
...
int building_pic (int type, int dx, int dy, int state) {
    ...
    /* get_base_pic */
    {
        switch (type) {
        case object_home          :
            base_pic = pic_town_hall;
            break;
        case object_mine          :
            base_pic = pic_mine;
            break;
        case object_building_site :
            base_pic = pic_building_site;
            break;
        case object_camp          :
            base_pic = pic_camp;
            break;
...
char *building_name (int type) {
    ...
    /* get_name */
    {
        ...
        case object_mine          :
            ...
            break;
        case object_building_site :
            strcpy (r, "building site");
            break;
        case object_site_docks    :
            strcpy (r, "building docks");
            break;
        case object_camp          :
            strcpy (r, "camp");
            break;
