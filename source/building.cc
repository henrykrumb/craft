...
int docks_dir (int x0, int y0)
  {int  dir;
   ...
   xs = x0    ; ys = y0 - 1; dx = 1; dy = 0; dd = -1;  /* check */      {ok = true;
      if   (dx != 0)
   ...
   xs = x0    ; ys = y0 + 3; dx = 1; dy = 0; dd =  1;  /* check */      {ok = true;
      if   (dx != 0)
            /* check_dx */      {for (int xw = xs; xw < xs + 3 && dx != 0; xw += dx)
        for (int i = 0; i < 3; i++)
            if (! land_properties [landscape [xw][ys + i * dd]].is_water)
   ...
   xs = x0 - 1; ys = y0    ; dx = 0; dy = 1; dd = -1;  /* check */      {ok = true;
      if   (dx != 0)
            /* check_dx */      {for (int xw = xs; xw < xs + 3 && dx != 0; xw += dx)
        for (int i = 0; i < 3; i++)
            if (! land_properties [landscape [xw][ys + i * dd]].is_water)
   ...
   xs = x0 + 3; ys = y0    ; dx = 0; dy = 1; dd =  1;  /* check */      {ok = true;
      if   (dx != 0)
            /* check_dx */      {for (int xw = xs; xw < xs + 3 && dx != 0; xw += dx)
        for (int i = 0; i < 3; i++)
            if (! land_properties [landscape [xw][ys + i * dd]].is_water)
