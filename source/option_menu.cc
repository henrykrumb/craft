...
void set_robot (int pno) {
    ...
    switch (i_random (0, 9)) {
    case 0 :
        strcpy (name [pno], "Sven");
        break;
    case 1 :
        strcpy (name [pno], "Thor");
        break;
    case 2 :
        strcpy (name [pno], "Haegedin");
        break;
    case 3 :
        strcpy (name [pno], "Roland");
        break;
    case 4 :
        strcpy (name [pno], "Lars");
        break;
    case 5 :
        strcpy (name [pno], "Frederik");
        break;
    case 6 :
        strcpy (name [pno], "Oehr");
        break;
    case 7 :
        strcpy (name [pno], "Lunda");
        break;
    case 8 :
        strcpy (name [pno], "Arnhold");
        break;
    case 9 :
        strcpy (name [pno], "Eric");
        break;
    };
}
            ...
            /* perhaps_type_change */      {
                if ( /* pno */      (act_menu - 2) > 0 &&
                    ...
                    if (b > 66 && prev_menu == act_menu)
                        ...
                        case m_player   : { /* set_to_robot */
                            active [ /* pno */      (act_menu - 2)]         = true;
                            menu_type [act_menu] = m_robot;
                            set_robot ( /* pno */      (act_menu - 2));
                        };
                        break;
                        case m_robot    : { /* set_to_inactive */
                            if   ( /* pno */      (act_menu - 2) < 2)
                                /* set_to_player */      {
                                active    [ /* pno */      (act_menu - 2)]      = true;
                                menu_type [act_menu] = m_player;
                                ...
                                active    [ /* pno */      (act_menu - 2)]      = false;
                                menu_type [act_menu] = m_inactive;
                            };
                        };
                        break;
                        case m_inactive : { /* set_to_player */
                            active    [ /* pno */      (act_menu - 2)]      = true;
                            menu_type [act_menu] = m_player;
                            strcpy  (host [ /* pno */      (act_menu - 2)], "");
                            sprintf (name [ /* pno */      (act_menu - 2)], "player %d",  /* pno */      (act_menu - 2));
...
void player_menu (int act_menu, int &tic) {
    ...
    /* init */      { /* show_pic */      {
        ...
        /* show_buttons */      {
            g_host  = new craft_getline  ("",w, host [ /* pno */      (act_menu - 2)],60,160,180, 20);
...
void option_menu (double &speed, int &tic) {
    ...
    while (! quit) {
        /* session */      {
            switch (menu_type [act_menu]) {
            case m_main     :
                main_menu     (act_menu, tic);
                break;
            case m_details  :
                details_menu  (act_menu, speed, tic);
                break;
            case m_player   :
                player_menu   (act_menu, tic);
                break;
            case m_robot    :
                robo_menu     (act_menu, tic);
                break;
            case m_inactive :
                inactive_menu (act_menu, tic);
                break;
            case m_cancel   :
                exit (0);
                break;
